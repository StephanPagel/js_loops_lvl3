...
// let cutText = () => {
//     for (x = 0; x <= text.length; x += 100) {
//         textPart = text.slice(x, x + 100) + `- ${x / 100 + 1} of ${Math.ceil(text.length / 100)} `;
//         text2.push(textPart);
//     }
//     console.log(text2);
// }
...
//     for (y = 2; y < numArr[x]; y++) {
//         if (numArr[x] % y == 0) {
//             output.innerHTML += `<p>Teiler von ${numArr[x]}:</p>`
//             output.innerHTML += `<p>${y}</p>`;
//         }
//     }
// }
